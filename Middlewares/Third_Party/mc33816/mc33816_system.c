...
{
    HAL_Delay(msDelay); // Use HAL library delay function for millisecond delay
}
...
{
	DWT_Delay(delay * 100); // Use DWT_Delay for 100us delay, adjust factor as needed for the specific MCU
}
...
// Description     : Sets the state of the MC33816 reset pin (HIGH or LOW)
// Return type     : void
// Argument        : int state
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
// Description     : This interrupt is enabled when MC33816 IRQB pin is low
// Return type     : void
// Argument        : void
///////////////////////////////////////////////////////////////////////////////////////////////////////////
void PORTA_IRQHandler(void) //IRQB
{
    ...
    // Off_sequence(); Optional since MC33816 will shutdown output by itself
