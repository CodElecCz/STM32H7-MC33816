...
static void MX_SPI1_Init(void)
{
  ...
  hspi1.Init.CLKPhase = SPI_PHASE_2EDGE; // MC33816 requires CPHA=0
...
static void MX_TIM5_Init(void)
{
  ...
  htim5.Instance = TIM5;
  htim5.Init.Prescaler = 2399; //100kHz counting frequency (240MHz / 2400)
...
static void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = MC_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MC_RST_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : MC_DBG_Pin */
  GPIO_InitStruct.Pin = MC_DBG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MC_DBG_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : MC_START5_Pin MC_START2_Pin MC_DRV_Pin MC_START4_Pin
                           MC_START1_Pin */
  GPIO_InitStruct.Pin = MC_START5_Pin|MC_START2_Pin|MC_DRV_Pin|MC_START4_Pin
                          |MC_START1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : MC_START6_Pin MC_START3_Pin */
  GPIO_InitStruct.Pin = MC_START6_Pin|MC_START3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(MC_IRQ_EXTI_IRQn, 5, 0);
  HAL_NVIC_EnableIRQ(MC_IRQ_EXTI_IRQn);
...
void StartDefaultTask(void *argument)
{
  ...
  for(;;)
  {
	...
	if (ADC_TriggerCapture_GetState(&capture) == ADC_TRIGGER_COMPLETE)
	{
		...
		MAIN_DEBUG_TRACE(ADC, ("Capture COMPLETE! %lu samples, trigger at index %lu\n",
			samples, capture.trigger_index));

		ADC_TriggerCapture_Idle(&capture);
		ADC_TriggerCapture_Arm(&capture);
	}
...
void MPU_Config(void)
{
  ...
  /* Disable the MPU */
	...
	/* Configure the MPU attributes as Normal Non Cacheable
	   for ADC DMA buffers in RAM_D3 (adc1_buffer, adc2_buffer @ 0x38000000) */
	MPU_InitStruct.Enable = MPU_REGION_ENABLE;
